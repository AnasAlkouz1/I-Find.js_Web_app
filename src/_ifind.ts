...
interface __TxN<G>{
    _fn:(_x:G)=>number | null ;
    _ft:(_x:G)=>string | null;
    _ftn:(_x:G)=>Array<string | number | null>;
    _r_all_s:(_x:G)=>string | null;
    _r_m_s:(_x:G)=>string | null;
    _fsl:(_x:G)=>string | null;
    _fcl:(_x:G)=>string | null;
}
interface __TxN_all extends _TxN{
_all:(_x:string)=>(string | number | null | (string| number | null)[] )[];
}


class _TxN implements __TxN<string>{
_fn(_x:string){
const __NumberArray:string[]=[];
...
class _TxN_all extends _TxN implements __TxN_all{
_all(_x){
